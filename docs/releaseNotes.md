...
## Version 3.9 (05 Jan 2024)
  ...
  * Allow configuring a custom reference set for the ExecutorProblem / Analyzer / Instrumenter.
...
## Version 2.13 (30 Dec 2019)
  ...
  * Several improvements to the progress listener, including:
    ...
    - `ProgressListener` now provides access to the current algorithm being run by
      the `ExecutorProblem`.  This can be used, for example, to get the contents of the
...
## Version 2.9 (9 Mar 2016)
  ...
  * Adds support for termination conditions.  The ExecutorProblem can now support
...
## Version 2.0 (11 Sep 2013)
  ...
  * ExecutorProblem can now report the progress, elapsed time, and estimated time
...
## Version 1.11 (29 Feb 2012)
  ...
  * Adds ClassLoaderProblems, allowing problems to be instantiated using their
    fully-qualified class name.  For example:
      new ExecutorProblem().withProblem("org.moeaframework.problem.misc.Kita")
...
## Version 1.10 (22 Jan 2012)
  ...
  * Adds support in ExecutorProblem, Analyzer and Instrumenter for instantiating
...
## Version 1.7 (29 Sept 2011)
  ...
  * Adds Analyzer class, similar in nature to ExecutorProblem, to reduce the amount of
    boilerplate code necessary to analyze end-of-run results.
   
  * Moves the ExecutorProblem class to reside in the top-level org.moeaframework
...
## Version 1.6 (10 September 2011)
  ...
  * Enhanced ExecutorProblem features, including:
...
## Version 1.5 (28 August 2011)
  ...
  * Adds ExecutorProblem class for convenient, programmatic execution of algorithms.
