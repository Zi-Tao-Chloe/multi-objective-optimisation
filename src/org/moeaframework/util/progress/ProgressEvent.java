...
public class ProgressEvent {
	...
	/**
	 * {@code true} if this event was created in response to a seed finishing; {@code false} otherwise.  This indicates
	 * that new results are available in the executor.
	 */
	...
	/**
	 * The maximum number of objective function evaluations per seed.  If {@code -1}, then no maximum NFE is set.
	 */
	...
	/**
	 * The maximum elapsed time per seed in seconds.  If {@code -1}, then no maximum time is set.
	 */
	 ...
	 * @param isSeedFinished {@code true} if this event was created in response to a seed finishing; {@code false}
	 *        otherwise
	 * @param currentNFE the current number of objective function evaluations for the current seed.
	 * @param maxNFE the maximum number of objective function evaluations per seed, or {@code -1} if not set
	 * @param percentComplete the percent complete as a fraction between {@code 0} and {@code 1}
	 * @param elapsedTime the elapsed time in seconds
	 * @param remainingTime the estimated remaining time in seconds
	 * @param maxTime the maximum elapsed time per seed in seconds, or {@code -1} if not set
	 */
	public ProgressEvent(Executor executor, Algorithm algorithm, int currentSeed, int totalSeeds,
			boolean isSeedFinished, int currentNFE,	int maxNFE, double percentComplete, double elapsedTime,
			double remainingTime, double maxTime) {
		super();
	 ...
	 * will return {@code 1 + getTotalSeeds()}.
	 * 
	...
	/**
	 * Returns {@code true} if this event was created in response to a seed finishing; {@code false} otherwise.  This
	 * indicates that new results are available in the executor.
	 * 
	 * @return {@code true} if this event was created in response to a seed finishing; {@code false} otherwise
	 */
	 ...
	 * 
	 * @return the current number of objective function evaluations for the current seed
	 */
	...
	/**
	 * Returns the maximum number of objective function evaluations per seed, or {@code -1} if not set.
	 * 
	...
	/**
	 * Returns the percent complete as a fraction between {@code 0} and {@code 1}.
	 * 
	 * @return the percent complete as a fraction between {@code 0} and {@code 1}
	 */
