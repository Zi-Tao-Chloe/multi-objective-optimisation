...
/**
 * The unconstrained UF7 test problem from the CEC 2009 special session and competition.
 */
public class UF7 extends AbstractProblem {
	...
	/**
	 * Constructs a UF7 test problem with the specified number of decision variables.
	 * 
