...
/**
 * The unconstrained UF2 test problem from the CEC 2009 special session and competition.
 */
public class UF2 extends AbstractProblem {
	...
	/**
	 * Constructs a UF2 test problem with the specified number of decision variables.
	 * 
