...
/**
 * The constrained CF8 test problem from the CEC 2009 special session and competition.
 */
public class CF8 extends AbstractProblem {
	...
	/**
	 * Constructs a CF8 test problem with the specified number of decision variables.
	 * 
