...
public class PopulationCollector implements Collector {
	...
	/**
	 * Constructs an unattached collector for recording the population from an {@code EvolutionaryAlgorithm}.
	 */
	...
	/**
	 * Constructs a collector for recording the population from the specified {@code EvolutionaryAlgorithm}.
	 * 
